...
HD_PWD='C:/Users/xushu/Desktop/FPGa/project/freDetect_2/freDetect_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log freDetect.vdi -applog -m64 -messageDb vivado.pb -mode batch -source freDetect.tcl -notrace
