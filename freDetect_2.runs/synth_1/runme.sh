...
HD_PWD='C:/Users/xushu/Desktop/FPGa/project/freDetect_2/freDetect_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log freDetect.vds -m64 -mode batch -messageDb vivado.pb -notrace -source freDetect.tcl
